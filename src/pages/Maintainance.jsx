...
const Maintenance = () => {
  ...
  const handleMasterSwitchChange = async (isChecked) => {
    try {
      await axios.post(`https://project-backend-xo17.onrender.com/api/service/maintenance-all-servers`, {
  ...
  const handleSwitchChange = async (serverNumber, isChecked) => {
    try {
      await axios.post(`https://project-backend-xo17.onrender.com/api/service/maintainance-server`, {
